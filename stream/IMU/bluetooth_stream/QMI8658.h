...
enum QMI8658Register
{
    ...
    /*! \brief FIFO Watermark Register*/
    QMI8658Register_FifoWtmTh = 19,
    /*! \brief FIFO control register. */
    QMI8658Register_FifoCtrl = 20,
    /*! \brief FIFO sample count register. */
...
enum QMI8658_Ctrl9Command
{
    ...
    QMI8658_Ctrl9_Cmd_Rqst_FIFO = 0X05,
...
extern unsigned char QMI8658_read_fifo_status(void);
extern void QMI8658_set_fifo_rd_mode();
extern void QMI8658_set_fifo_write_mode();
extern void QMI8658_read_fifo_data(short acc_fifo[][3], short gyro_fifo[][3], unsigned int num_samples);
extern void QMI8658_config_fifo(unsigned char fifo_mode, unsigned char fifo_size);
extern bool QMI8658_fifo_empty();
extern bool QMI8658_fifo_full();
extern unsigned short QMI8658_fifo_count();
extern unsigned int QMI8658_read_timestamp();
extern void QMI8658_config_fifo(unsigned char fifo_mode, unsigned char fifo_size, unsigned char fifo_watermark);
