...
class GlobalSpline2D(interpolate.interp2d):
    def __init__(self, x, y, z, kind='linear', degree=3):
    ...
    @staticmethod
    def _extrap1d(xs, ys, tar_x, degree=3):
        ...
        f = interpolate.InterpolatedUnivariateSpline(xs, ys, k=degree)
        return f(tar_x)
        ...
        for y in ys:
            ...
            for x in xs:
                ...
                if not extrap_based_xs and not extrap_based_ys:
                    ...
                    pz = self._extrap1d(extrap_based_ys, extrap_based_zs, y, self.degree)
                    ...
                    extrap_based_zs = super().__call__(extrap_based_xs,
                                                       y,
                                                       **kwargs)
                    pz = self._extrap1d(extrap_based_xs, extrap_based_zs, x, self.degree)
